export const faqItems = [
  {
    question: "What is Food Book?",
    answer:
      "Food Book is a platform that connects food lovers with the best street food vendors, food trucks, and pop-up restaurants in their area. We provide reviews, locations, menus, and community discussions around your local street food scene.",
    category: "general",
  },
  {
  ...
  {
    question: "What's the difference between Premium and Standard memberships?",
    answer:
  ...
  {
    question: "Is Food Book available in my city?",
    answer:
      "Food Book is rapidly expanding! We currently operate in over 50 major cities across North America, Europe, and Asia. Check our 'Locations' page to see if your city is covered. If not, join our waitlist and we'll notify you when we launch in your area.",
    category: "service",
  },
  {
  ...
  {
    question: "How do vendors join Food Book?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes, all reviews on Food Book are from verified customers who have checked in or ordered from the vendor through our platform. This helps maintain review integrity and provides authentic feedback for both customers and vendors.",
    category: "usage",
  },
  {
  ...
  {
    question: "Can I order food for delivery through Food Book?",
    answer:
